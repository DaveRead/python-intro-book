...
\beforefig
\centerline{\includegraphics[width=0.9\textwidth]{figs2/arch3NoSoftware.eps}}
\afterfig
...
\url{https://www.monead.com/introcompsci/mbox.txt} 
...
Note the example reads a file but the same pattern should be used when writing a file.
