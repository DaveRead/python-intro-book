...
You may get the length of a nested array by using the \texttt{len()} function with the element containing the nested array You may use additional square brackets to access specific elements of a nested array.
...
The program produces the output that starts like this:
...
\url{https://www.monead.com/introcompsci/romeo.txt}
